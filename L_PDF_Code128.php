...
class L_PDF_Code128 extends FPDF {
...
//____________________________ Extension du constructeur _______________________ Changed orientation from P
function __construct($orientation='L', $unit='mm', $format='Letter') 
